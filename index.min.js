...
{displayScore();alert("You fail to DDOS your neighbours")}else if(score>=100)
{displayScore();alert("Good job !! Your neighbours is OFFLINE.");start=!0;document.location.reload()}
